...
[![GitHub](https://img.shields.io/github/license/zuribehobide23/iwvg-devops-behobide-zurine?color=informational)](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/blob/develop/LICENSE.md)
[![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/zuribehobide23/iwvg-devops-behobide-zurine?color=informational)](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/releases)
![GitHub Release Date](https://img.shields.io/github/release-date/zuribehobide23/iwvg-devops-behobide-zurine?color=informational)
![GitHub code size in bytes](https://img.shields.io/github/languages/code-size/zuribehobide23/iwvg-devops-behobide-zurine)
![GitHub issues](https://img.shields.io/github/issues/zuribehobide23/iwvg-devops-behobide-zurine?color=important)
![GitHub closed issues](https://img.shields.io/github/issues-closed/zuribehobide23/iwvg-devops-behobide-zurine?color=informational)

### Estado del código
[![DevOps](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/actions/workflows/ci.yml/badge.svg)](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/actions/workflows/ci.yml)
...
[![Render Deployment](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/actions/workflows/cd-staging.yml/badge.svg)](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/actions/workflows/cd-staging.yml)
[![AWS Deployment](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/actions/workflows/cd-master.yml/badge.svg)](https://github.com/zuribehobide23/iwvg-devops-behobide-zurine/actions/workflows/cd-master.yml)
...
* Feature 2ª: :two: mejorar el filtro de búsqueda añadiendo una tercera condición: **billable**, significa que el usuario es facturable,
...
#### 7. Bug (**1.5 ptos**)
> Suponer que la Feature 2ª anterior existe un error. Error encontrado es que si el user contiene el role de ADMIN, no se puede desactivar, aspecto que no se tenía en cuenta. Realizar un cambio y proceder a la cuarta liberación del código **staging** y **main**.
...
* Gestión adecuada, completa y equilibrada (estimación, tiempo real...) durante el desarrollo. **Hasta -2 ptos**.
